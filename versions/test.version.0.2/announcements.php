...
<div id="announcements">
        ...
        <article class="white mini-module-container">
                ...
                <form action="forms/makeAnnouncement.php" method="post" id="makeAnnouncement">
                        ...
                        <p><label for="date">Exxpiry Date:</label><span style="display:inline-block;*display:inline;zoom:1;position:relative"><input data-datepicker="datepicker" class="small date" type="text" name="date" value="" /></span></p>
                        
                        <p><label for="title">Title:</label><input type="text" id="title" name="title" /></p>
                        
                        <p class="textarea"><label for="message">Content:</label><textarea id="message" name="message" class="form-text"></textarea><br><span style="margin-left:130px">HTML tags allowed. Use &lt;h4&gt; for headings</span></p>
