	...
	$.ajax({
		...
		success: function(data){
			...
			if($success=="success")
			{
				...
				$(".dbResponseSuccess").delay(1500).slideUp(function() { $('.ajaxResponse').remove(); } );
			...
			else
			{
				...
				$(".dbResponseFailure").delay(1500).slideUp(function() { $('.ajaxResponse').remove(); } );
		...
		error: function(jqXHR, textStatus, errorThrown){
			...
			$(".AjaxResponseFailure").delay(1500).slideUp(function() { $('.ajaxResponse').remove(); } );
			console.log(
