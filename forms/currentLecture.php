...
//echo $mins;
$get   = "select subject,lecture_start_time,lecture_end_time,id_no,fname, lname from timetable INNER JOIN professors ON timetable.professor_assigned = professors.id_no where department='$_SESSION[department]' and sem='$semester' and day='$whichday'";
